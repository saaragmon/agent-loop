...
WORKERS = [
    {"key": "strands", "name": "AWS Strands", "colour": "cyan", "file": "workers/strands/strands_worker.py", "runner": "python"},
    {"key": "pydantic", "name": "Pydantic AI", "colour": "green", "file": "workers/pydantic/pydantic_worker.py", "runner": "python"},
    {"key": "maf", "name": "Microsoft Agent Framework", "colour": "magenta", "file": "workers/maf/maf_worker.py", "runner": "python"},
    {"key": "agno", "name": "Agno", "colour": "yellow", "file": "workers/agno/agno_worker.py", "runner": "python"},
    {"key": "mastra", "name": "Mastra", "colour": "blue", "file": "workers/mastra/worker.ts", "runner": "node"},
]
